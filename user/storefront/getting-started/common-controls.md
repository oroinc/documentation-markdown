...
#### HINT
The Saved Search feature is available starting from OroCommerce Enterprise v4.2.4. To find out which application version you are running, ask your system administrator to check the [system information](../../back-office/system/system-information/index.md#system-information).
...
#### HINT
The feature is available starting from OroCommerce v4.2.5. To find out which application version you are running, ask your system administrator to check the [system information](../../back-office/system/system-information/index.md#system-information).
