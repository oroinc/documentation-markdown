...
Since OroCommerce Enterprise Edition supports multiple [warehouses](../../back-office/inventory/create.md#user-guide-inventory-warehouse-create), orders in this application edition show information on the warehouse that the goods are shipped from.
