...
You can configure each of the following menu elements on five different levels: [global](../../../back-office/system/frontend-menus/index.md#frontend-menu-globally), [organization](../../../back-office/system/user-management/organizations/organization-frontend-menus.md#frontend-menu-organization), [website](../../../back-office/system/websites/website-frontend-menus.md#frontend-menus-website), [customer group](../../../back-office/customers/customer-groups/customer-group-frontend-menus.md#frontend-menus-customer-group), and a [customer](../../../back-office/customers/customers/customer-frontend-menus.md#frontend-menus-customer). Always keep an eye on the fallback logic, which means that the values set on a more specific level (e.g., customer level) would always prevail and override the configuration set on a more general level (e.g., global).
