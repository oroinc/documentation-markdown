<a id="user-guide-web-catalog-edit-content-tree"></a>
...
3. Click <i class="fa fa-sitemap fa-lg" aria-hidden="true"></i> **Edit Content Tree** at the top right of the page.
   ![Clicking Edit Content Tree at the top right of the page](user/img/marketing/web_catalogs/EditContentTree.png)
...
#### NOTE
You can drag the existing content nodes to a different position within the content tree to the left of the page, as illustrated below:
