...
#### NOTE
Creating a new content block requires developers’ assistance. As a sample, use the Home Page Slider content block, <a href="https://github.com/oroinc/orocommerce/blob/7.0/src/Oro/Bundle/CMSBundle/Tests/Behat/Features/Fixtures/home_page_slider_content_widget_fixture.yml" target="_blank">configuration</a> in the yaml file that helps embed it into the website homepage.
