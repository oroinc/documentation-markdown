...
Read the [My Configuration](my-configuration.md#doc-my-user-configuration-profile) topic for the details on configuring available system settings for a particular user.
