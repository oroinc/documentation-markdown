<a id="doc-grids-actions-records-create"></a>
...
2. Fill in all the required information.
   ...
   Note that mandatory fields are identified with the asterisk.
...
3. Save the new record by clicking one of the options in the save menu or discard it by clicking **Cancel** at the top right of the page.
