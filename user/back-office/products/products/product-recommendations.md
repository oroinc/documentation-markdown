...
You can enable and configure the Similar Products feature in the system configuration [globally](../../system/configuration/commerce/catalog/global-related-products.md#sys-commerce-catalog-relate-products), per [organization](../../system/user-management/organizations/org-configuration/commerce/catalog/organization-related-products.md#sys-users-organization-commerce-catalog-related-products), and per [website](../../system/websites/web-configuration/commerce/catalog/website-related-products.md#sys-websites-commerce-catalog-related-products). For example, you can enable buyers to add a similar product to the shopping list directly from the product view page where the recommendation appears or toggle the minimum and maximum number of products displayed on the page.

![Illustration of similar product recommendations in the back-office and storefront](user/img/products/recommendations/similar-products.png)
...
![Global related items configuration](user/img/products/recommendations/related-products-config.png)
...
You can enable and configure the up-sell product feature options [globally](../../system/configuration/commerce/catalog/global-related-products.md#sys-commerce-catalog-relate-products), per [organization](../../system/user-management/organizations/org-configuration/commerce/catalog/organization-related-products.md#sys-users-organization-commerce-catalog-related-products), and per [website](../../system/websites/web-configuration/commerce/catalog/website-related-products.md#sys-websites-commerce-catalog-related-products).

![Illustration of the related and up-sell products segments in the storefront](user/img/products/recommendations/up-sell-config.png)
...
A featured products block on the storefront homepage is represented by a [segment](../../reports-segments/segments.md#user-guide-business-intelligence-filters-segments) configured to include all products that you have marked as featured on the product page in the back-office.

![Product marked as featured](user/img/products/recommendations/is-featured.png)![Creating a segment with a list of all products marked as featured](user/img/products/recommendations/featured-segment.png)

Once the segment is ready, you can connect it to the storefront website [via the system configuration](../../system/configuration/commerce/product/global-featured-products.md#sys-commerce-product-featured-products).

![Connecting the featured segment to the storefront](user/img/products/recommendations/connect-segment-to-storefront.png)![Featured segment homepage](user/img/products/recommendations/featured-products-homepage.png)
