...
1. In the **General** section:
   ...
   8. In the **Tax Code** list, select the [product tax code](../../taxes/product-tax-codes/index.md#taxes-product-tax-code) that defines the percentage of tax that may be included into the purchase order during the checkout.
...
1. In the **Product Price** section, add fixed product prices. Note that fixed prices override the automatically generated [price lists](../../../concept-guides/pricing/index.md#user-guide-pricing).
...
3. Review translation rules for a product name, URL slug, description, and short description.
   ...
   To enter translation manually, click <i class="fas fa-language" aria-hidden="true"></i>, clear the **Use <parent translation>** check box next to the required language, and provide your version of the translation.
...
6. In the **Select Up-Sell Items For** dialog:
   ...
   #### NOTE
   To delete a related item, click <i class="fas fa-trash-alt" aria-hidden="true"></i> **Delete**  next to it.
7. Once you are done adding the related items, click **Save and Close**.
