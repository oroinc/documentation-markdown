...
By default, *each* is set as the primary product unit but you can mark any of the available units as primary in the [system configuration](../../../system/configuration/commerce/product/product-units.md#sys-commerce-product-product-units).
...
More information on inventory is available in the [Warehouse and Inventory](../../../inventory/index.md#user-guide-inventory) section.
