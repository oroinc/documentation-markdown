...
3. Provide the following details on the page that opens:
   ...
   * **Enable Session Transfer** — Allow the application to exchange an access token issued to it for a short-lived,
     ...
     [Session Transfer](../../../../bundles/platform/OAuth2ServerBundle/session-transfer.md#bundle-docs-platform-oauth2-server-bundle-session-transfer) for integration details.
