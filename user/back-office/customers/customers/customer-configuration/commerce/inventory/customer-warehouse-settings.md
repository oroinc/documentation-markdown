<a id="user-guide-customers-inventory-settings"></a>
...
1. Clear the **Use Customer Group** checkbox next to the required setting to enable or disable customers in the storefront to view inventory levels on the following pages:
