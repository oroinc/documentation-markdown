<a id="user-guide-customer-configuration-settings-ai-agent"></a>

# Configure AI Smart Agent Settings per Customer
...
![AI Smart Agent configuration settings on the customer level](user/img/customers/customers/configuration/customer-ai-agent-settings.png)
...
To enable AI Smart Agent per customer:
...
4. In the **AI Smart Agent** section, clear the **Use Customer Group** checkbox and select the **Enable AI Smart Agent** checkbox to enable the feature in the storefront.
