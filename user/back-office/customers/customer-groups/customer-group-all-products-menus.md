<a id="user-guide-customers-customer-groups-all-products"></a>
...
3. Click <i class="fas fa-cog" aria-hidden="true"></i> **Edit Storefront Menu** at the top right.
4. Click on the menu to which you will add the All Products page.
5. Click **Create Menu Item** at the top right of the page.
