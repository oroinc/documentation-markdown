<a id="user-guide-customers-customer-group-inventory-settings"></a>
...
1. Clear the **Use Website** checkbox next to the required setting to enable or disable customers in the storefront to view **inventory levels** (available as of OroCommerce version 6.1.3) on the following pages:
