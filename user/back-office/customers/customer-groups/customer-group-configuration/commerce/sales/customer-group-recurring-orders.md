<a id="user-guide-customer-group-sales-recurring-orders"></a>
...
4. By default, the Recurring Orders functionality is disabled. To update any of the options, clear the **Use Website** checkbox first.
