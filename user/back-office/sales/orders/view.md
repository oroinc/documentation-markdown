...
To edit the activity, click the <i class="fa fa-ellipsis-h fa-lg" aria-hidden="true"></i> **More Options** menu at the end of the row and click <i class="fa fa-edit fa-lg" aria-hidden="true"></i> **Update**. In the dialog that appears, make required changed and then click **Save**.
