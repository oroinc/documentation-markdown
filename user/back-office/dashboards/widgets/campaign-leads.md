...
* **Hide campaigns that are not used for any leads/opportunities** — select *Yes* for the option to hide campaigns that have not been associated with any leads or opportunities, helping you focus only on active and relevant campaigns.
