...
**Example:** See <a href="https://symfony.com/doc/4.4/reference/twig_reference.html#url" target="_blank">the Symfony Twig Extensions (URL)</a>
...
**Example:** See <a href="https://symfony.com/doc/4.4/reference/twig_reference.html#path" target="_blank">the Symfony Twig Extensions (Path)</a>
...
**Returns:** array of OroBundlePaymentBundleTwigDTOPaymentMethodObject objests with payment method label and options
...
**Returns:** string, one of OroBundlePaymentBundleProviderPaymentStatusProvider class statuses
