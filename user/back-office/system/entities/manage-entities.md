...
* **Include in Smart Insights** — When set to *Yes*, this entity will be considered in [OroIQ Smart Insights](../../../concept-guides/ai/index.md#concept-guide-oroiq) to generate analytics, trends, and contextual recommendations (available as of OroCommerce version 7.0.2).
