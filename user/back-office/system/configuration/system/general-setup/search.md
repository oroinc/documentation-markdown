<a id="configuration-system-configuration-general-setup-sysconfig-search-global"></a>
...
1. Configure the following options:
   ...
   * **Enable Search Synonyms** — (available as of OroCommerce Enterprise v.6.1.10.) Select this option to enable Elasticsearch search synonyms. When enabled, searches return results for configured synonymous terms (for example, abbreviations and their full forms, such as St and Street, or NC and North Carolina). Synonym groups are configured by developers and cannot be managed from the back-office.
