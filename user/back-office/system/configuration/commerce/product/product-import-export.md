<a id="configuration-guide-commerce-product-import-export"></a>
...
2. Select **Commerce > Product > Product Import/Export** in the menu to the left.

   #### NOTE
   For faster navigation between the configuration menu sections, use [Quick Search](../../quick-search.md#user-guide-system-configuration-quick-search).
3. To customize any options, clear the **Use Default** checkbox next to them and select the required value.
4. In the **Category Options** section, customize the following options:
