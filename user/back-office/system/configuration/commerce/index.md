<a id="configuration-guide-commerce-configuration"></a>
...
* [Customer User Login](customer/customer-user-login.md#sys-config-configuration-commerce-customers-customer-user-login)
...
* [Order Draft Edit Mode](orders/global-order-draft-edit.md#system-configuration-orders-draft-edit-mode)
