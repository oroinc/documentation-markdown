<a id="configuration-guide-commerce-configuration-sales"></a>

# Configure Global Sales Settings

Learn how to enable the quick order form, promotions, guest shopping lists, establish the preferred discount strategy, setup notifications to the sales representatives of the customers, restrict the number of shopping lists per customer, configure recurring orders, invoices, and define customer visible contact information.
...
* [Recurring Orders](../../../websites/web-configuration/commerce/sales/website-recurring-orders.md#user-guide-system-configuration-commerce-sales-recurring-orders)
