<a id="configuration-guide-commerce-configuration-saved-search"></a>
...
1. You can enable or disable the following options (clear the **Use Default** check box to customize the settings):
