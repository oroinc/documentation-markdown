...
The created divider will appear as the last one on the list of children of the same parent item. You can move it to the position that you need, as described in the [Toggle the Menu Tree View](index.md#doc-config-menus-actions-draganddrop-frontend) action description. Reload the page to see changes.
