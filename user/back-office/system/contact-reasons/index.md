...
![Select a contact reason from the drop-down list in the storefront](user/img/system/contact_reasons/select_reasons_storefront.png)
...
![Select a contact reason from the drop-down list in the storefront](user/img/system/contact_reasons/contact_request_page.png)
