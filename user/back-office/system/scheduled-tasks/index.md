...
With Oro, you can use the <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/CronBundle" target="_blank">OroCronBundle</a>, which runs Symfony Console commands through [cronjobs](../../../../backend/cron.md#dev-guide-system-cron-jobs) (on UNIX-based operating systems) or Windows task scheduler.
