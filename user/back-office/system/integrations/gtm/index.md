...
#### WARNING
As of July 1, 2024, Google Universal Analytics has been replaced by Google Analytics 4 (GA4). Please refer to our [Google Tag Manager (GA4) configuration guide](../gtm-ga4/index.md#gtm-ga-4-integration) for instructions on how to set up Google Tag Manager with Google Analytics 4.
