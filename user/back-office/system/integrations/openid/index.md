...
#### IMPORTANT
Logging out of Oro does not terminate the corresponding session at the identity provider (Single Logout is not supported). Users remain signed in to the third-party IdP after logging out of the storefront or back-office.
...
* **Website** — (available as of OroCommerce v6.1.10.) Available only when the *Customer Pro bundle* is installed and *Customer User* is selected in the *Apply to* field. Determines the storefront website on which the button is displayed.
