<a id="configuration-commerce-orders-order-creation-website"></a>
...
3. Select **Commerce > Orders > Order Creation** in the menu to the left.

   #### NOTE
   For faster navigation between the configuration menu sections, use [Quick Search](../../../../configuration/quick-search.md#user-guide-system-configuration-quick-search).
4. In the **Order Creation** section, clear the **Use Organization** checkbox next to the required option, if it is selected, to toggle the following options:
