<a id="configuration-website-commerce-search-saved-search"></a>
...
1. You can enable or disable the following options (clear the **Use Organization** check box to customize the settings):
