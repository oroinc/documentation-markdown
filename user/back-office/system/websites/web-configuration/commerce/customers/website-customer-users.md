<a id="system-website-configuration-commerce-customers-customer-users"></a>
...
3. Select **Commerce > Customer > Customer Users** in the menu on the left.
   ...
   ![Customer User settings on website level](user/img/system/websites/web_configuration/website-config-customer-user.png)
