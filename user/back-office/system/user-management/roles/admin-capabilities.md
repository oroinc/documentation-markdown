...
* **Search** — Enables users to [search](../../../../concept-guides/search/index.md#user-guide-getting-started-search) for specific records within the application. The setting does not influence the user’s ability to [search by tag](../../../../concept-guides/search/index.md#user-guide-getting-started-search-tag).
