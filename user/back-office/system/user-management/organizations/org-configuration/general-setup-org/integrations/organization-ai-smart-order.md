<a id="organization-ai-smart-order-settings"></a>
...
AI Smart Order is available for OroCommerce Enterprise and is aimed at simplifying the process of handling purchase orders. With AI Smart Order [dashboard widget](../../../../../../dashboards/widgets/ai-smart-order.md#user-guide-dashboards-widgets), you can have emailed PDFs and other document types converted directly into draft orders in your OroCommerce application.
