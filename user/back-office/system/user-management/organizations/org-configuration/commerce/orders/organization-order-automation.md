<a id="configuration-commerce-orders-order-automation-organization"></a>
...
1. In the **Order Automation** section:
   ...
   2. Select the **Enable Automatic Order Cancellation** check box to automatically cancel the order when its ‘do not ship later than’ date is passed.
