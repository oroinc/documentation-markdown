...
#### HINT
This section is part of the [Storefront and Back-Office Menu Management Concept Guide](../../../concept-guides/menus/index.md#menu-management-concept-guide) topic that provides the general understanding of the available storefront and back-office menu types and their management in Oro applications.
...
To view and edit menu contents, click on the menu name or on the <i class="fa fa-eye fa-lg" aria-hidden="true"></i> **View** icon in the corresponding row of the menu list.
