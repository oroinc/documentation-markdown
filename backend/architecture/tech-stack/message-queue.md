...
- <a href="https://github.com/oroinc/platform/tree/4.2/src/Oro/Component/MessageQueue/Consumption/QueueConsumer.php" target="_blank">QueueConsumer</a> - A class that works inside the command and watch
