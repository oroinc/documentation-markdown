...
Before you begin, follow the [Custom Application](../framework/index.md#dev-guide-application-web-framework) topic to set up your custom application repository for version control, then install the Oro application from your custom repository.
