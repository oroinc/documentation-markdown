...
The <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/MessageQueueBundle" target="_blank">OroMessageQueueBundle</a> implements the DBAL broker. Because the bundle is part of OroPlatform, this broker is available in all Oro applications out of the box.
