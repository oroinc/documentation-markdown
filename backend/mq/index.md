...
The DBAL broker is implemented by the <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/MessageQueueBundle" target="_blank">OroMessageQueueBundle</a>. It is part of OroPlatform which means that this broker is available in all Oro applications out-of-the-box.
