...
#### HINT
This feature is available starting from OroCommerce v4.2.7. To check which application version you are running, see the [system information](../../user/back-office/system/system-information/index.md#system-information).
