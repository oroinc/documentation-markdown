...
In this article, you will learn how you can improve the experience of writing functional tests with OroPlatform. We recommend that you read the Symfony <a href="https://symfony.com/doc/5.4/testing.html#functional-tests" target="_blank">documentation concerning testing</a>  before you continue. You should also be familiar with <a href="http://phpunit.de" target="_blank">PHPUnit</a>.
