...
#### HINT
Screenshots taken during failed Behat tests include the last cursor position from moving the mouse, except when there are alerts on the page. This helps identify where the failure occurred, so you can take corrective action more quickly.
