...
1. Create a class that implements <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/ScopeBundle/Manager/ScopeCriteriaProviderInterface.php" target="_blank">ScopeCriteriaProviderInterface</a>,
