...
Take a look at the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/ApiBundle/Request/RequestType.php" target="_blank">RequestType</a> class. It holds different aspects of a request, and the
