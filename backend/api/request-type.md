...
<a href="http://jsonapi.org/format/" target="_blank">JSON:API specification</a>, you need different sets of processors. Some processors work for all
...
Take a look at the <a href="https://github.com/oroinc/platform/blob/master/src/Oro/Bundle/ApiBundle/Request/RequestType.php" target="_blank">RequestType</a> class. It holds different aspects of a request, and the
