...
identifier. The class extends <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/ApiBundle/Tests/Functional/RestJsonApiTestCase.php" target="_blank">RestJsonApiTestCase</a> and automatically adds the `X-Integration-Type: ext_id`
