...
The <a href="https://github.com/oroinc/platform/blob/master/src/Oro/Bundle/ApiBundle/Collection/QueryExpressionVisitor.php" target="_blank">QueryExpressionVisitor</a> walks a graph of DQL expressions from the Criteria object and turns them into a query. It is similar to
