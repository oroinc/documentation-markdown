...
<a href="https://github.com/oroinc/platform/tree/6.1/src/Oro/Bundle/EntityBundle/Model/EntityAlias.php" target="_blank">Entity aliases</a> provide a simple way to refer to entities.
...
To use entity aliases, rely on <a href="https://github.com/oroinc/platform/tree/6.1/src/Oro/Bundle/EntityBundle/ORM/EntityAliasResolver.php" target="_blank">EntityAliasResolver</a>, which provides functions for obtaining aliases from given class names and vice versa.
...
To do this, implement the <a href="https://github.com/oroinc/platform/tree/6.1/src/Oro/Bundle/EntityBundle/Provider/EntityAliasProviderInterface.php" target="_blank">EntityAliasProviderInterface</a> interface in your provider class:
