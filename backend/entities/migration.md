...
Use the queries parameter to execute additional SQL queries before or after applying a schema modification. This parameter is a <a href="https://github.com/oroinc/platform/blob/master/src/Oro/Bundle/MigrationBundle/Migration/QueryBag.php" target="_blank">query bag</a> that lets you add queries to run before (addPreQuery method) or after (addQuery or addPostQuery method) the modification.

A query can be a string or an instance of a class that implements the <a href="https://github.com/oroinc/platform/blob/master/src/Oro/Bundle/MigrationBundle/Migration/MigrationQuery.php" target="_blank">MigrationQuery</a> interface. Several ready-to-use implementations are available:
...
* <a href="https://github.com/oroinc/platform/blob/master/src/Oro/Bundle/MigrationBundle/Migration/Extension/DataStorageExtension.php" target="_blank">DataStorageExtension</a> - Used to exchange data between different migrations.
