...
For example, the <a href="https://github.com/oroinc/platform/blob/5.1/src/Oro/Bundle/DataGridBundle/Datasource/Orm/OrmDatasource.php" target="_blank">OrmDatasource</a> dispatches 4 main and 2 additional events in its `getResult()` method:
