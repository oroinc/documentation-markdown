...
<a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/DataGridBundle/Extension/FieldAcl/FieldAclExtension.php" target="_blank">Field ACL extension</a> allows checking access to grid columns. Currently, it is implemented only for the ORM datasource.
