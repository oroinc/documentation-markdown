...
You can use <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/ImportExportBundle/Writer/CsvEchoWriter.php" target="_blank">existing CSV writer</a> as an example for your writer.
