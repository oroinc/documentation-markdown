...
*src/Acme/Bundle/DemoBundle/Resource/translations/messages.en.yml*
```yaml
acme:
    demo:
        mass_actions:
...
*src/Acme/Bundle/DemoBundle/Resource/translations/jsmessages.en.yml*
```yaml
acme:
    demo:
        mass_actions:
...
*src/Acme/Bundle/DemoBundle/Datagrid/Extension/MassAction/CustomTypeAction.php*
```php
namespace Acme\Bundle\DemoBundle\Datagrid\Extension\MassAction;
