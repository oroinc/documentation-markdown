...
includes the <a href="https://github.com/oroinc/platform/tree/4.2/src/Oro/Bundle/EntityConfigBundle" target="_blank">EntityConfigBundle</a> that makes it easy to configure additional metadata of your
...
#### NOTE
Checkout the Attributes topic to learn how to assign functionality for entity to [create and manipulate attributes](../attributes.md#dev-entities-attributes).
...
[indexed key](#book-entities-configuration-options) in the `options` section. When this
