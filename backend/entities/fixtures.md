...
To make a fixture versioned, implement <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/MigrationBundle/Fixture/VersionedFixtureInterface.php" target="_blank">VersionedFixtureInterface</a> and the getVersion method that returns a version of the fixture data.
...
If the fixture needs to know the last loaded version, implement <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/MigrationBundle/Fixture/LoadedFixtureVersionAwareInterface.php" target="_blank">LoadedFixtureVersionAwareInterface</a> and the setLoadedVersion method:
