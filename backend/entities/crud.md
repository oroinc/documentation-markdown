...
#### SEE ALSO
Learn more about <a href="https://symfony.com/doc/4.4/book/forms.html" target="_blank">form types in the Symfony documentation</a>.
...
[already used](data-grids/index.md#cookbook-entities-grid-controller) to embed the data grid comes with a
...
See the sample configuration of the default `DELETE` operation in the <a href="https://github.com/oroinc/platform/tree/4.2/src/Oro/Bundle/ActionBundle/Resources/config/oro/actions.yml" target="_blank">Actions</a> topic.
