...
#### CAUTION
A datasource must implement the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/DataGridBundle/Datasource/BindParametersInterface.php" target="_blank">BindParametersInterface</a> to support the `bind_parameters` option.
