...
This is a complex association type, so use the <a href="https://github.com/oroinc/platform/blob/5.1/src/Oro/Bundle/ActivityBundle/Manager/ActivityManager.php" target="_blank">ActivityManager</a> class to work with activities.
