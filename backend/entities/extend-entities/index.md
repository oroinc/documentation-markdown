...
To solve this, you can use <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/EntityExtendBundle" target="_blank">EntityExtendBundle</a> which offers the following features:
...
*src/Acme/Bundle/DemoBundle/Migrations/Schema/v1_1/AddDocumentRatingColumn.php*
```php
<?php
