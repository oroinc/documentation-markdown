...
The Oro <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/EntityExtendBundle" target="_blank">EntityExtendBundle</a> allows to create a particular type of relationship between entities named
...
To help working with multi-target associations the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/EntityExtendBundle/Entity/Manager/AssociationManager.php" target="_blank">AssociationManager</a> class was created.
