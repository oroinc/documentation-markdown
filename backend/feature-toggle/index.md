<!-- meta: description = Practical guides on enabling and disabling application features via the system configuration UI in the Oro application backend -->
...
> - `datagrids` — A list of [datagrid](../entities/data-grids/index.md#data-grids) names. These datagrids are not available when the feature is disabled.
