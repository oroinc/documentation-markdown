...
The <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/NavigationBundle" target="_blank">OroNavigationBundle</a> automatically processes the `navigation.yml` file placed in the `Resources/config/oro` directory of a registered bundle. Place the menu configuration under the `menu_config` tree.
