...
To add additional options, create a class that implements <a href="https://github.com/oroinc/platform/tree/6.1/src/Oro/Bundle/SecurityBundle/AccessRule/AccessRuleOptionMatcherInterface.php" target="_blank">AccessRuleOptionMatcherInterface</a> and decorate the oro_security.access_rule_option_matcher service.
...
For example, <a href="https://github.com/oroinc/platform/tree/6.1/src/Oro/Bundle/SecurityBundle/ORM/Walker/AstVisitor.php" target="_blank">AstVisitor</a> converts access rule expressions to Doctrine AST conditions.
