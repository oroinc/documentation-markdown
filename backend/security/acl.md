...
1. Use the `@Acl` annotation on a controller method, providing the entity class name and the permission to check for:
   > *src/Acme/Bundle/DemoBundle/Controller/ProductController.php*
   > ```php-annotations
   ...
   >  }
   > ```
2. When you need to perform a particular check repeatedly, write `@Acl` repeatedly. This, however, is tedious, especially when your requirements change and you have to change a lot of ACLs.
...
* <a href="https://github.com/oroinc/platform/blob/5.0/src/Oro/Bundle/SecurityBundle/Authorization/ClassAuthorizationChecker.php" target="_blank">ClassAuthorizationChecker</a>
* <a href="https://github.com/oroinc/platform/blob/5.0/src/Oro/Bundle/SecurityBundle/Authorization/RequestAuthorizationChecker.php" target="_blank">CRequestAuthorizationChecker</a>
