<!-- meta: description = An overview of the logging concept, strategy, and standards -->
...
#### HINT
This feature is available starting from OroCommerce v4.2.2. To check which application version you are running, see the [system information](../../user/back-office/system/system-information/index.md#system-information).
...
Oro applications use Monolog integration with the Symfony framework with a few additional features built on top. Follow the official Symfony documentation for details on how to configure features like writing logs to different locations, registering a custom log handler (e.g., Mongo, New Relic, Slack), or enabling log rotation (see <a href="https://symfony.com/doc/4.4/logging.html#monolog" target="_blank">Symfony Monolog Documentation</a>).
