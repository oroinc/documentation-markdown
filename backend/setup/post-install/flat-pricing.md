...
Out of the box, OroCommerce uses [Combined Price List (CPL)](../../../user/concept-guides/catalog-promotions/pricing/index.md#user-guide-pricing) pricing, built for large, complex B2B businesses with multiple price lists, pricing strategies, price fallbacks, and price merges.
