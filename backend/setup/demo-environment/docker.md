...
<a href="https://github.com/mailhog/MailHog" target="_blank">Smtp service</a> is additionally launched so you can send emails from the application. It receives all mail and provides a web interface for viewing it and performing the required actions. The mail catcher web interface is available at [http://oro.demo/mailcatcher](http://oro.demo/mailcatcher).
