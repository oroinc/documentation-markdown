...
3. Configure PHPStorm:
   ...
   * Enable code quality checks in PHPStorm:
     * <a href="https://confluence.jetbrains.com/display/PhpStorm/PHP+Code+Sniffer+in+PhpStorm" target="_blank">Enable PHP Code Sniffer</a> (use PSR2 or Symfony2 code standards)
     * <a href="https://confluence.jetbrains.com/display/PhpStorm/PHP+Mess+Detector+in+PhpStorm" target="_blank">Enable PHP Mess Detector</a>, making sure that:
...
If you are using CentOS, you can follow the [Environment Setup for Community Edition](community-edition.md#environment-setup-community)
or [Environment Setup for the Enterprise Edition](enterprise-edition.md#environment-setup-enterprise) to set up the environment for your custom Oro application.
Otherwise, we recommend using [Docker and Symfony Server](docker-and-symfony/index.md#setup-dev-env-docker-symfony).
