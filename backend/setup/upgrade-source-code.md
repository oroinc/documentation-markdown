...
If you run a version of OroCommerce earlier than 5.1, skip the upgrade to 5.1 and upgrade directly to version 6.0.
...
#### NOTE
oro/platform 5.0.18 is available only for Enterprise customers and partners.
...
[moves the datagrids configuration](https://github.com/oroinc/platform/blob/6.0.0/CHANGELOG.md#datagrids)
to the theme level.
...
Once the source code is upgraded, the next step is to upgrade the Oro application to v6.0. For full instructions, refer to the [Upgrading the Application to the Next Version](upgrade-to-new-version.md#upgrade-application) documentation.
