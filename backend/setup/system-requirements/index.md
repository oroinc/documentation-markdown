...
| *Assets*          | * <a href="https://nodejs.org/en/" target="_blank">Node.js</a> >=24.11<br/>* <a href="https://pnpm.io/" target="_blank">PNPM</a> >=10.7.0<br/><br/>Used for JS assets minification and SCSS assets<br/>build.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| *Database*         | * <a href="https://www.postgresql.org/" target="_blank">PostgreSQL</a> / <a href="https://www.enterprisedb.com/" target="_blank">EnterpriseDB</a> >=17.6 |
