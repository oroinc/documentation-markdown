...
More recommendations are available in [MySQL](database-optimization.md#mysql-optimization) topic in Oro documentation.
...
For more information on Symfony performance optimization, see the list of all recommendations on <a href="https://symfony.com/doc/4.4/performance.html" target="_blank">Symfony website</a>.
...
More recommendations on improving Doctrine performance are available on <a href="https://www.doctrine-project.org/projects/doctrine-orm/en/2.6/reference/improving-performance.html" target="_blank">Doctrine website</a>.
...
You can use <a href="https://blackfire.io/" target="_blank">Blackfire</a> at any stage of application’s lifecycle to gather data about the behavior of your current codebase, analyze profiles and optimize the code.
