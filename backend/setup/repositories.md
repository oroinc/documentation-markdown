<!-- meta: description = Learn how OroCommerce is structured across public Community Edition and private Enterprise Edition repositories, including applications, packages, and components hosted on GitHub. -->
...
#### HINT
Once you identify the repository you need, follow the [Get the Oro Application Source Code guide](get-source-files.md#platform-installation-source-files) to clone and start working with the codebase.
