...
You can configure this attribute when you use <a href="https://github.com/oroinc/platform/blob/4.2/src/Oro/Bundle/AttachmentBundle/Provider/AttachmentProvider.php" target="_blank">AttachmentProvider</a>.
...
This attribute configures [Custom Form Type for Fields](../../entities/extend-entities/index.md#book-entities-extended-entities-custom-form-type-for-fields) .
...
This attribute is set for <a href="https://github.com/oroinc/orocommerce/blob/4.2/src/Oro/Bundle/RedirectBundle/Entity/SluggableInterface.php" target="_blank">SluggableInterface</a>.
