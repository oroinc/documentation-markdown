...
You can configure this attribute when you use <a href="https://github.com/oroinc/platform/blob/5.0/src/Oro/Bundle/AttachmentBundle/Provider/AttachmentProvider.php" target="_blank">AttachmentProvider</a>.
...
* **state** *string* - the state of the extend config field. See available states in <a href="https://github.com/oroinc/platform/blob/5.0/src/Oro/Bundle/EntityExtendBundle/EntityConfig/ExtendScope.php" target="_blank">ExtendScope.php</a>.
...
* **index** *string[]* - a list of index fields of the entity. See available index states in <a href="https://github.com/oroinc/platform/blob/5.0/src/Oro/Bundle/EntityBundle/EntityConfig/IndexScope.php" target="_blank">IndexScope.php</a>
...
This attribute is set for <a href="https://github.com/oroinc/orocommerce/blob/5.0/src/Oro/Bundle/RedirectBundle/Entity/SluggableInterface.php" target="_blank">SluggableInterface</a>.
