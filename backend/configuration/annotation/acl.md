...
determines whether to evaluate the ACL when checking a user’s access to a class. If the given action is annotated with the <a href="https://symfony.com/doc/5.0/bundles/SensioFrameworkExtraBundle/annotations/converters.html" target="_blank">ParamConverter</a>
...
A unique identifier, used for example to reference an access control list with the [@AclAncestor annotation](acl-ancestor.md#acl-ancestor).
