...
|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Root Node  | `datagrids`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Options    | * [actions]()<br/>* [action_configuration]()<br/>* [columns](#reference-datagrid-columns)<br/>* [extends]()<br/>* [filters]()<br/>  * [columns](#reference-datagrid-filters-columns)<br/>  * [default](#reference-datagrid-filters-default)<br/>* [options]()<br/>  * [base_datagrid_class]()<br/>  * [export]()<br/>* [properties]()<br/>* [sorters]()<br/>  * [columns](#reference-datagrid-sorters-columns)<br/>  * [default](#reference-datagrid-sorters-default)<br/>* [source]()<br/>  * [acl_resource]()<br/>  * [bind_parameters]()<br/>  * [query]()<br/>  * [type]() |
...
When using the ORM data source (by setting the [type]() option to `orm`), you can pass any data
...
When using the ORM data source (by setting the [type]() option to `orm`), you have to configure
...
> [query option](#reference-format-datagrid-type-orm) for a list of the available additional
> options).
