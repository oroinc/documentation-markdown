...
If a [scope configuration](../../scopes/index.md#dev-scopes) is provided for a workflow, the Oro application filters all available workflows by the scopes defined for the workflow_definition scope type and uses only the selected ones.
