...
Once the translation file is updated, load its translations into the system by running the [oro:translation:load](../../../bundles/platform/TranslationBundle/commands.md#oro-translation-load-command) command.
