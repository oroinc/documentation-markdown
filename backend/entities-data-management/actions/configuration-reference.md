...
Structure of configuration is declared in the <a href="https://github.com/oroinc/platform/tree/4.2/src/Oro/Bundle/ActionBundle/Configuration/Configuration.php" target="_blank">configuration.php</a> file.
...
* **mass_action_provider** - *string* - Service name. This service must be marked with the oro_action.datagrid.mass_action_provider tag. Also it must implement OroBundleActionBundleDatagridProviderMassActionProviderInterface. The “getActions” method of this provider must return array of mass action configurations.
