...
Structure of configuration is declared in the <a href="https://github.com/oroinc/platform/blob/5.0/src/Oro/Bundle/ActionBundle/Configuration/Configuration.php" target="_blank">configuration.php</a> file.
