...
* [Buttons](buttons.md#bundle-docs-platform-action-bundle-buttons) are a user interface component that delivers custom actions for user interaction. Through a specific <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/ActionBundle/Extension/ButtonProviderExtensionInterface.php" target="_blank">ButtonsProviderExtension</a> together with <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/ActionBundle/Button/ButtonInterface.php" target="_blank">Buttons</a> matched by a context, they surface these actions (operations, for example) to the UI in the proper context.
