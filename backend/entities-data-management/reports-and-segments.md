...
Building a new report follows the same process as defining a data grid. A data grid is a YAML configuration living in a
...
#### SEE ALSO
This example is taken from <a href="https://github.com/oroinc/crm/blob/7.0/src/Oro/Bundle/ReportCRMBundle/Resources/config/oro/datagrids.yml" target="_blank">ReportBundle</a>, which is part of OroPlatform. Refer to it for more
examples.

You can also find more information on data grids in the <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/DataGridBundle" target="_blank">DataGridBundle</a> documentation.
