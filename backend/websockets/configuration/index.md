...
For example, install <a href="http://supervisord.org/" target="_blank">Supervisord</a> and configure it to run the WebSocket server with the following configuration:
