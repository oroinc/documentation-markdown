...
The WebSocket client uses the [authentication tickets mechanism](authentication-autorization.md#dev-cookbook-system-websockets-authentication-autorization), so you do not need to handle authentication on the backend side.
