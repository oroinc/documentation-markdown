...
As discussed in the section on [WebSockets Architecture](../index.md#dev-guide-system-websockets-architecture), all WebSocket messages in Oro applications are published to a particular topic. Clients subscribe to the topics they are interested in.
