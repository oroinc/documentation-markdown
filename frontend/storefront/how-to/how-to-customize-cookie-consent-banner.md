...
The title, text, and policy page link are set in the back-office, under **System > Configuration > Commerce > Customer > Customer Users > Cookies Banner**. No code is needed. See [Cookie Consent Banner](../../../user/storefront/cookie-consent-banner/index.md#frontstore-guide-cookie-banner) for details.
...
```none
 ...
 <div class="cookie-banner-view__inner-container" data-skip-focus-decoration tabindex="0">
     <div class="cookie-banner-view__content cms-typography">
         <h4 class="cookie-banner-view__title"><%= bannerTitle %></h4>
 ...
 <button class="close-dialog absolute btn btn--icon btn--colored-inverse" data-role="close" title="<%- _.__('Close') %>"
