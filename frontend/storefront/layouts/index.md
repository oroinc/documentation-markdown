...
#### NOTE
Each action is usually compiled as a separate call to the corresponding method of the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Component/Layout/LayoutManipulatorInterface.php" target="_blank">LayoutManipulatorInterface</a>.
...
must implement the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Component/Layout/ContextItemInterface.php" target="_blank">ContextItemInterface</a>.
...
Each configurator should implement the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Component/Layout/ContextConfiguratorInterface.php" target="_blank">ContextConfiguratorInterface</a>,
...
* By adding them to the data collection of the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Component/Layout/ContextInterface.php" target="_blank">layout context</a>. This method can be used for page-specific data or the data retrieved from the HTTP request.
...
You can also implement the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/LayoutBundle/Layout/DataProvider/AbstractFormProvider.php" target="_blank">AbstractFormProvider</a> if you use forms.
...
If you want to add some data to the layout context, you can use the data method of <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Component/Layout/ContextInterface.php" target="_blank">layout context</a>.
This method returns an instance of <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Component/Layout/ContextDataCollection.php" target="_blank">ContextDataCollection</a>. Use the set method of this collection to add data:
...
For example, here is the customized toolbar element defined in the <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/DataGridBundle" target="_blank">DataGridBundle</a> on the product page ([ProductBundle](../../../bundles/commerce/ProductBundle/index.md#bundle-docs-commerce-product-bundle)) in the OroCommerce application:
