...
#### HINT
Option `redis_dsn_layout` is available starting from OroPlatform v5.0.3. To check which application version you are running, see the [system information](../../user/back-office/system/system-information/index.md#system-information).
