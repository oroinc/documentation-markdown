...
We understand that every brand has its own unique corporate identity that sets it apart in the market. While OroCommerce offers options to [customize the look and feel of the new theme in the back-office](../../user/back-office/system/theme-configuration/index.md#back-office-theme-configuration), we have compiled this style guide to assist you in customizing the current Refreshing Teal theme interface to align it with your corporate identity.
...
Once you have downloaded the <a href="https://static.oroinc.com/doc/storefront-style-guide-6.0.fig" target="_blank">Style Guide</a> (Storefront Style Guide 6.0) and <a href="https://static.oroinc.com/doc/design-mockups-6.0.fig" target="_blank">Design Mockups</a> (Design Mockups 6.0) files, you can start customizing and use the provided Figma library:
...
1. In the newly imported library file (Storefront Style Guide 6.0), open the Assets tab in the left panel and click on the book icon.
