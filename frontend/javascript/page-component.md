<a id="dev-doc-frontend-page-component"></a>
...
BaseComponent is a module <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/UIBundle/Resources/public/js/app/components/base/component.js" target="_blank">oroui/js/app/components/base/component</a> very similar to Backbone.View. The difference is that it is not visible and has no functionality to interact with DOM.
