<!-- meta: description = Extensive documentation on the JavaScript web applications architecture for the frontend developers -->

<a id="dev-doc-frontend-javascript"></a>

# JavaScript Architecture

Client-side architecture of Oro application is built on <a href="http://chaplinjs.org/" target="_blank">Chaplin</a> architecture for JavaScript Web applications based on the <a href="http://backbonejs.org/" target="_blank">Backbone.js</a> library).
...
Macros from @OroAsset/Asset.html.twig is used for passing options to the application’s constructor. The configuration is placed in @OroUI/js_modules_config.html.twig template:
...
This enables the creation of the so-called global views. These views are kept in the memory,
...
an alternative approach that enables you to use multiple controllers, each of which
...
Curious to learn more about <a href="https://oroinc.com/b2b-ecommerce/what-is-b2b-ecommerce/" target="_blank">B2B e-commerce</a> and how it is different from B2C? Read our comprehensive guide on this topic.
