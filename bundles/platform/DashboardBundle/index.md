<a id="bundle-docs-platform-dashboard-bundle"></a>

# OroDashboardBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/DashboardBundle" target="_blank">OroDashboardBundle</a> introduces different widget types and manages the configuration of user dashboards and dashboard widgets.
