...
<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/SyncBundle/" target="_blank">OroSyncBundle</a> uses GosWebSocketBundle to enable real-time websocket notifications between an Oro application server and users’ browsers.
