<a id="bundle-docs-platform-entity-pagination-bundle"></a>

# OroEntityPaginationBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/EntityPaginationBundle" target="_blank">OroEntityPaginationBundle</a> enables pagination UI for a collection of entities when these entities are part of a data set of a DataGrid.
