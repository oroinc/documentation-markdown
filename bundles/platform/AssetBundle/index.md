...
Please follow <a href="https://github.com/oroinc/platform/tree/4.2/CHANGELOG.md#assetbundle-1" target="_blank">upgrade documentation</a> to update assets.yml files according to new requirements.
