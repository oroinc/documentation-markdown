<a id="bundle-docs-platform-asset-bundle"></a>

# OroAssetBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/AssetBundle" target="_blank">OroAssetBundle</a> adds the possibility to install project assets using webpack.
...
<a id="bundle-docs-platform-asset-bundle-load-css-from-bundle"></a>
...
Please follow <a href="https://github.com/oroinc/platform/blob/7.0/CHANGELOG.md#assetbundle-1" target="_blank">upgrade documentation</a> to update assets.yml files according to new requirements.
...
1. You exited the `oro:assets:build` command with <kbd>control</kbd> + <kbd>z</kbd> and node process hanged up. To fix, stop the node process manually.
