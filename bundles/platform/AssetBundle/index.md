...
<a href="https://github.com/oroinc/platform/tree/5.1/src/Oro/Bundle/AssetBundle" target="_blank">OroAssetBundle</a> adds the possibility to install project assets using webpack.
...
Please follow <a href="https://github.com/oroinc/platform/blob/5.1/CHANGELOG.md#assetbundle-1" target="_blank">upgrade documentation</a> to update assets.yml files according to new requirements.
