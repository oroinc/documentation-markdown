<a id="bundle-docs-platform-segment-bundle"></a>

# OroSegmentBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/SegmentBundle" target="_blank">OroSegmentBundle</a> provides GUI for application users to create named sets of entity records called Segments. It also enables the application of existing segments as filtering conditions in query designers.
