<a id="bundle-docs-platform-redis-bundle-configure-servers"></a>
...
See [Configure Application to Use Redis](configuration.md#bundle-docs-platform-redis-bundle-configuration) for details on how to
