<a id="bundle-docs-platform-sidebar-bundle"></a>

# OroSidebarBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/SidebarBundle" target="_blank">OroSidebarBundle</a> adds sidebars to the desktop version of the Oro application management UI and allows application users to enable or disable this feature in the system configuration menu.
