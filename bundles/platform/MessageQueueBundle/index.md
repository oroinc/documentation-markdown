<a id="bundle-docs-platform-message-queue-bundle"></a>

# OroMessageQueueBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/MessageQueueBundle" target="_blank">OroMessageQueueBundle</a> incorporates the OroMessageQueue component into OroPlatform and thereby provides message queue processing capabilities for all application components.
