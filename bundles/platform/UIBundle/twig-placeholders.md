<a id="bundle-docs-platform-ui-bundle-twig-placeholders"></a>
...
Each property can be a constant or an expression supported by [System Aware Resolver Component](../../components/system-aware-resolver.md#dev-components-system-aware-resolver). Examples exist in the current *placeholders.yml* files.
