...
The list of allowed HTML tags can be found in the <a href="https://github.com/oroinc/platform/blob/master/src/Oro/Bundle/FormBundle/Resources/config/oro/app.yml" target="_blank">app.yml</a> configuration file.
