<a id="bundle-docs-platform-ui-bundle"></a>

# OroUIBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/UIBundle" target="_blank">OroUIBundle</a> defines the architecture of the front-end part of Oro application and provides tools that ensure coordinated work of the architecture parts.
