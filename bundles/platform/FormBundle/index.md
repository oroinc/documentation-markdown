<a id="bundle-docs-platform-form-bundle"></a>

# OroFormBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/FormBundle" target="_blank">OroFormBundle</a> implements a set of form types and validation rules for the application data entry. The bundle allows to reuse specialized form elements and improves the data entry experience.
