<a id="bundle-docs-platform-distribution-bundle"></a>

# OroDistributionBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/DistributionBundle" target="_blank">OroDistributionBundle</a> enables application bundles registration based on their YAML configuration files without changing the application files. It also provides CLI to manage Oro packages in the applications.
