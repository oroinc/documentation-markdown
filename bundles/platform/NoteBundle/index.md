<a id="bundle-docs-platform-note-bundle"></a>

# OroNoteBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/NoteBundle" target="_blank">OroNoteBundle</a> provides the ability for the application users to add notes on an entity record page and enable or disable this feature for every entity type in the entity management UI.
