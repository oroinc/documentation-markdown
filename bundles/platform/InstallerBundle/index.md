...
<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/InstallerBundle" target="_blank">OroInstallerBundle</a> enables developers to install Oro applications in a prepared environment using the CLI and define activities for the installation process on a bundle level.
...
- $commandExecutor - An instance of the <a href="https://github.com/oroinc/platform/blob/7.0/src/Oro/Bundle/InstallerBundle/CommandExecutor.php" target="_blank">CommandExecutor</a> class. You can use it to execute Symfony console commands
