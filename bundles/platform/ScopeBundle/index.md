...
<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/ScopeBundle" target="_blank">OroScopeBundle</a> introduces the Scope entity into the Oro applications. A scope is a set of application parameters that have different values in different requests.
