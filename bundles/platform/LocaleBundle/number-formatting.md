<a id="bundle-docs-platform-locale-bundle-number-formatting"></a>
...
This class formats different styles of numbers in localized format and proxies intl extension class <a href="http://www.php.net/manual/en/class.numberformatter.php" target="_blank">NumberFormatter</a>.
