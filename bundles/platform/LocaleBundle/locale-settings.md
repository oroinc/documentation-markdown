<a id="bundle-docs-platform-locale-bundle-locale-settings"></a>
...
See address formats in the [Address Formatting topic](address-formatting.md#bundle-docs-platform-locale-bundle-address-formatting).
