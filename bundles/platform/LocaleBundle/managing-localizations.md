<a id="bundle-docs-platform-locale-bundle-managing-localizations"></a>
...
Gets the default Localization. The default Localization is obtained from the system configuration (see <a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/ConfigBundle" target="_blank">OroConfigBundle</a> for more information).
