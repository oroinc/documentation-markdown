<a id="bundle-docs-platform-entity-bundle"></a>

# OroEntityBundle

<a href="https://github.com/oroinc/platform/tree/7.0/src/Oro/Bundle/EntityBundle" target="_blank">OroEntityBundle</a> extends the Doctrine ORM functionality with additional field types and helpers. The bundle introduces entity aliases that enable the entity types reference in a shorter form.
