<a id="bundle-docs-extensions-stripe-payment-bundle-configuration"></a>

# Configuration

The default configuration of <a href="https://github.com/oroinc/orocommerce-stripe" target="_blank">OroStripePaymentBundle</a> is illustrated below:
