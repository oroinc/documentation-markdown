<a id="bundle-docs-extensions-stripe-payment-bundle-stripe-amount-format"></a>
...
* `\Oro\Bundle\StripePaymentBundle\StripeAmountConverter\ConfigurableDecimalPlacesStripeAmountConverter` — a converter that allows to specify the number of decimal places for a currency. It covers the currencies that do not follow Stripe’s standard decimal places rules, e.g., HUF, TWD.
