<!-- meta: description = This class provides a way to merge configurations with equal names from any configuration group. -->

<a id="dev-components-configuration-merger"></a>
...
1. Merge configurations with the same name from two bundles and extend one configuration from another configuration (use append strategy).
...
1. Merge configurations with the same name from two bundles and extend one configuration from another configuration (use append and replace strategy).
