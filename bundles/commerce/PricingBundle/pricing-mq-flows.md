<a id="bundle-docs-commerce-pricing-bundle-mq-flows"></a>
...
For the description of *what user actions produce these messages*, see [Pricing and Search Index](pricing-and-search.md#bundle-docs-commerce-pricing-bundle-search). For the conceptual description of the combined price lists build, see [Combined Price List](combined-price-lists.md#bundle-docs-commerce-pricing-bundle-combined-price-lists).
...
* [Pricing and Search Index](pricing-and-search.md#bundle-docs-commerce-pricing-bundle-search) — the user actions and listeners that produce these messages.
* [Combined Price List](combined-price-lists.md#bundle-docs-commerce-pricing-bundle-combined-price-lists) — the conceptual description of the CPL build.
