<a id="bundle-docs-commerce-pricing-bundle-expression-lang"></a>
...
Use this article to learn how the expression language is implemented and how to extend it. For the syntax used to create expressions, see [Filtering Expression Syntax](../../../user/back-office/sales/price-lists/auto.md#user-guide-pricing-auto-expression) and [Price Rule Automation Examples](../../../user/back-office/sales/price-lists/auto.md#price-rules-auto-examples).

## Architecture Overview

The expression language consists of three layers:

* **Oro\\Component\\Expression** — a generic, reusable engine built on top of the Symfony <a href="https://symfony.com/doc/6.4/components/expression_language.html" target="_blank">ExpressionLanguage Component</a>. It parses an expression into a tree of nodes and converts this tree into Doctrine query expressions. The component has no knowledge of specific entities.
...
* [Filtering Expression Syntax](../../../user/back-office/sales/price-lists/auto.md#user-guide-pricing-auto-expression)
* [Price Rule Automation Examples](../../../user/back-office/sales/price-lists/auto.md#price-rules-auto-examples)
* [Expression Editor and Autocomplete](../../../user/back-office/sales/price-lists/autocomplete.md#user-guide-pricing-price-list-auto-autocomplete)
