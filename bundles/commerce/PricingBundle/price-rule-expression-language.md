...
* **Oro\\Component\\Expression** — a generic, reusable engine built on top of the Symfony <a href="https://symfony.com/doc/5.4/components/expression_language.html" target="_blank">ExpressionLanguage Component</a>. It parses an expression into a tree of nodes and converts this tree into Doctrine query expressions. The component has no knowledge of specific entities.
