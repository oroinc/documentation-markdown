<a id="bundle-docs-commerce-cms-bundle-editor-components"></a>
...
| modelProps   | Object   | Methods and props used to extend the WYSIWYG <a href="https://grapesjs.com/docs/api/component.html#component" target="_blank">component model</a>. Prop defaults is merged with the default model attributes. |
...
|----------|----------|------------|--------------------------------------------------------------------------------------------------------------------------------------|
| priority | Number   | Optional   | Define the priority order for applying the component type. The priority is used when you create a component type from a parent type. |
...
| isComponent           | Object|String|Boolean | DOMNode   | Identify the <a href="https://grapesjs.com/docs/modules/Components.html#iscomponent" target="_blank">the component type</a> |
...
For more information about jsmodules.yml, see [JS Modules](../../../backend/configuration/yaml/jsmodules.md#reference-format-jsmodules).
