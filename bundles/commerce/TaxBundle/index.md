...
1. Create tax provider that implements <a href="https://github.com/oroinc/orocommerce/tree/4.2/src/Oro/Bundle/TaxBundle/Provider/TaxProviderInterface.php" target="_blank">TaxProviderInterface</a> interface:
