...
Trait <a href="https://github.com/oroinc/orocommerce/blob/6.1/src/Oro/Bundle/WebsiteSearchBundle/Tests/Functional/WebsiteSearchExtensionTrait.php" target="_blank">WebsiteSearchExtensionTrait</a> contains methods which help reindex data in test if required.
