<a id="bundle-docs-commerce-customer-part-number-bundle-commands"></a>
...
using them together to move off the legacy OroLab implementation, see [Migrating from the Legacy OroLab
Bundle](migrating-from-orolab.md#bundle-docs-commerce-customer-part-number-bundle-migrating-from-orolab).

<a id="customer-part-number-migrate-from-orolab-command"></a>
...
#### NOTE
`Migrations\Schema\OroCustomerPartNumberInstaller` runs this migration automatically the first time
...
<a id="customer-part-number-cleanup-orolab-command"></a>
...
#### NOTE
The legacy table `orolab_customer_part_number` and its columns are intentionally NOT dropped by this
