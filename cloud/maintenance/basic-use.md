...
#### NOTE
You will be prompted to enter a tag or branch to clone the application source file from. Use a valid tag or branch from the Oro application repository, for example, the <a href="https://github.com/oroinc/orocommerce-application/tree/1.6" target="_blank">1.6</a> branch or the|1.6.1| tag.
...
#### NOTE
You will be prompted to enter a tag or branch to clone the application source file. Use a valid tag or branch from the Oro application repository (for example, the <a href="https://github.com/oroinc/orocommerce-application/tree/1.6" target="_blank">1.6</a> branch or the <a href="https://github.com/oroinc/orocommerce-application/tree/1.6.1" target="_blank">1.6.1</a> tag).
...
#### NOTE
even if the oro:platform:update command is not executed, the assets will be redeployed.
...
[Execute Update Cached Translated Values operation](../../user/back-office/system/localization/translations/index.md#update-translation-cache)
...
#### NOTE
Please always use underscores instead of spaces for the source directory name and for all file names too.
