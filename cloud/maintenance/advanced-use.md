...
![Protection layers used by the OroCloud application](cloud/img/cloud/protection_layers.png)
...
* Autonomous Systems (<a href="https://en.wikipedia.org/wiki/Autonomous_system_(Internet)" target="_blank">ASN</a>)
* Countries
* User Agents
...
![Rate limit detailed processing flow.](cloud/img/cloud/rate_limit.png)

Request rate is calculated for the source IP addresses sharing the same <a href="https://en.wikipedia.org/wiki/Autonomous_system_(Internet)" target="_blank">ASN</a> or originating from the zones defined by the setup, e.g.:
...
To profile application web requests from your browser, follow the <a href="https://blackfire.io/docs/introduction" target="_blank">Blackfire documentation</a>.
