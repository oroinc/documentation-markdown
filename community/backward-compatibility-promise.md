<!-- meta: description = Oro application backward compatibility promise -->
...
In compliance with our [Release Process](release-process.md#doc-community-release) and to ensure clear expectations, we use a
