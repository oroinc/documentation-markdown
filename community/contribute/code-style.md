...
PHP code style is controlled by the <a href="https://github.com/squizlabs/PHP_CodeSniffer" target="_blank">PHP CodeSniffer tool</a> according to the rules defined <a href="https://github.com/oroinc/platform/tree/6.1/build/Oro/phpcs.xml" target="_blank">in the phpcs.xml file</a>.
...
#### IMPORTANT
To enable the JavaScript code style checker in PHPStorm, navigate to **“Languages & Frameworks > JavaScript > Code Quality Tools > ESLint”** and select to use the configuration from <a href="https://github.com/oroinc/platform-application/tree/6.1/.eslintrc.yml" target="_blank">.eslintrc.yml</a>.
...
#### IMPORTANT
To enable the CSS(SCSS) code style checker in PHPStorm, navigate to **“Languages & Frameworks > Style Sheets > Stylelint”**, enable it, and chose configuration file <a href="https://github.com/oroinc/platform-application/tree/6.1/.stylelintrc.yml" target="_blank">.stylelintrc.yml</a>, <a href="https://github.com/oroinc/platform-application/tree/6.1/.stylelintignore" target="_blank">.stylelintignore</a> from the root repository.
